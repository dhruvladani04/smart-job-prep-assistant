...
// export default function ResumeCard({ rewrite, onEdit, onDelete, onToggleFavorite, isSelected }) {
...
//   return (
//     <motion.div
//       className={`relative bg-white rounded-xl shadow-sm border-2 transition-all duration-200 overflow-hidden ${
...
//               <button
//                 type="submit"
//                 className="ml-2 px-2 py-1 text-sm text-white bg-blue-500 rounded-md hover:bg-blue-600"
//               >
//                 Save
//               </button>
//             </form>
...
//             {rewrite.content.substring(0, 150)}{rewrite.content.length > 150 ? '...' : ''}
//           </p>
//         </div>
